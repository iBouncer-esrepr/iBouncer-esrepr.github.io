...
# 以下の項目は、本文内の2カラムエリアで個別に呼び出すため、
# 標準レイアウト（最下部表示）を避けるためにここではfalse気味に設定するか、
# liquidタグで直接制御します。
news: false
...
<div class="row">
  <div class="col-sm-8">
    ...
    * **Researcher (Lecturer (Research Fellow) and Research Support Specialist)** | Kobe University
    ...
    {% if site.softwares or site.selected_papers %}
  ...
  <div class="col-sm-4">
    ...
    <h3 class="card-title" style="font-size: 1.2rem;">News</h3>
    {% include news.liquid %}

    <hr>

    <h3 class="card-title" style="font-size: 1.2rem;">Hobbies</h3>
    <ul style="list-style: none; padding-left: 0; font-size: 0.95rem;">
      <li>☕️ <strong>Coffee</strong>: Pour-over brewing</li>
      <li>🚗 <strong>Driving</strong>: Exploring Okitama region</li>
      <li>💻 <strong>Open-source</strong>: Coding with Python/uv</li>
    </ul>
